 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Ag=pe,$g=Symbol.for("react.element"),Lg=Symbol.for("react.fragment"),Fg=Object.prototype.hasOwnProperty,Ig=Ag.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner,bg={key:!0,ref:!0,__self:!0,__source:!0};function Vd(e,t,n){var r,i={},o=null,l=null;n!==void 0&&(o=""+n),t.key!==void 0&&(o=""+t.key),t.ref!==void 0&&(l=t.ref);for(r in t)Fg.call(t,r)&&!bg.hasOwnProperty(r)&&(i[r]=t[r]);if(e&&e.defaultProps)for(r in t=e.defaultProps,t)i[r]===void 0&&(i[r]=t[r]);return{$$typeof:$g,type:e,key:o,ref:l,props:i,_owner:Ig.current}}Xo.Fragment=Lg;Xo.jsx=Vd;Xo.jsxs=Vd;Ld.exports=Xo;var g=Ld.exports,Bs={},Kd={exports:{}},et={},Qd={exports:{}},Gd={};/**
 * @license React
...
`,ux=()=>g.jsxs(ax,{children:[g.jsxs(zr,{children:[g.jsx(Nr,{src:"./Assets/mile2-aseets/icons/1.svg",alt:"Ramen Icon"}),"YENİ! Kore"]}),g.jsxs(zr,{children:[g.jsx(Nr,{src:"./Assets/mile2-aseets/icons/2.svg",alt:"Pizza Icon"}),"Pizza"]}),g.jsxs(zr,{children:[g.jsx(Nr,{src:"./Assets/mile2-aseets/icons/3.svg",alt:"Burger Icon"}),"Burger"]}),g.jsxs(zr,{children:[g.jsx(Nr,{src:"./Assets/mile2-aseets/icons/4.svg",alt:"Fast Food Icon"}),"Fast Food"]}),g.jsxs(zr,{children:[g.jsx(Nr,{src:"./Assets/mile2-aseets/icons/5.svg",alt:"Soft Drinks Icon"}),"Soft Drinks"]})]}),cx=C.div`
  display: flex;
  justify-content: center;
  align-items: center;
  min-height: 700px;
...
`;function Gm(){return g.jsxs(zx,{children:[g.jsxs(Nx,{children:[g.jsxs("div",{style:{width:"50%",display:"flex",alignItems:"center",justifyContent:"center"},children:[g.jsxs(bx,{style:{width:"360px",height:"263.56px"},children:[g.jsx("img",{src:"/Assets/mile2-aseets/footer/logo-footer.svg",style:{width:"50%"}}),g.jsxs(Os,{children:[g.jsx("img",{src:"./Assets/mile2-aseets/footer/icons/icon-1.png"}),g.jsx("p",{children:"341 Londonderry Road, Istanbul Türkiye"})]}),g.jsxs(Os,{children:[g.jsx("img",{src:"./Assets/mile2-aseets/footer/icons/icon-2.png"}),g.jsx("p",{children:"aciktim@teknolojikyemekler.com"})]}),g.jsxs(Os,{children:[g.jsx("img",{src:"./Assets/mile2-aseets/footer/icons/icon-3.png"}),g.jsx("p",{children:"+90 216 123 45 67"})]})]}),g.jsxs("div",{className:"footer-pizza-hot",children:[g.jsx("p",{style:{fontWeight:"500",fontSize:"24px",lineHeight:"32.11px",marginBottom:"40px"},children:"Hot Menu"}),g.jsxs(Dx,{children:[g.jsx(Ln,{children:"Terminal Pizza"}),g.jsx(Ln,{children:"5 Kişilik Hackathon Pizza"}),g.jsx(Ln,{children:"useEffect Tavuklu Pizza"}),g.jsx(Ln,{children:"Beyaz Console Frosty"}),g.jsx(Ln,{children:"Testler Geçti Mutlu Burger"}),g.jsx(Ln,{children:"Position Absolute Acı Burger"})]})]})]}),g.jsx(Fx,{style:{width:"50%"},className:"instagram-div",children:g.jsxs(Lx,{children:[g.jsx(Ix,{children:"Instagram"}),g.jsx($n,{src:"./Assets/mile2-aseets/footer/insta/li-0.png"}),g.jsx($n,{src:"./Assets/mile2-aseets/footer/insta/li-1.png"}),g.jsx($n,{src:"./Assets/mile2-aseets/footer/insta/li-2.png"}),g.jsx($n,{src:"./Assets/mile2-aseets/footer/insta/li-3.png"}),g.jsx($n,{src:"./Assets/mile2-aseets/footer/insta/li-4.png"}),g.jsx($n,{src:"./Assets/mile2-aseets/footer/insta/li-5.png"})]})})]}),g.jsx(Ax,{children:g.jsxs($x,{children:[g.jsx("p",{children:"© 2023 Teknolojik Yemekler."}),g.jsx("p",{children:g.jsx(Tx,{})})]})})]})}const Mx=C.div`
  display: flex;
  justify-content: center;
  align-items: center;
  min-height: 100vh;
